...
public abstract class AbstractGroupedNamedModelInstance implements IGroupedNamedModelInstance {
  @NonNull
  private final IChoiceGroupInstance parent;

  protected AbstractGroupedNamedModelInstance(@NonNull IChoiceGroupInstance parent) {
    this.parent = parent;
  }
