...
//
// @Override
// protected IConstraintSet parseResource(URI resource, Deque<URI>
// visitedResources) throws IOException {
//
// // parse this metaschema
// MetaschemaMetaConstraintsDocument xmlObject = parseConstraintSet(resource);
//
// MetaschemaMetaConstraintsDocument.MetaschemaMetaConstraints constraints =
// xmlObject.getMetaschemaMetaConstraints();
//
// for (ModelContextType context : constraints.getContextList()) {
// assert context != null;
// List<ITargetedConstaints> targets = parseContext(context,
// null).getTargetedConstraints();
// }
//
...
// }
//
// private Context parseContext(@NonNull ModelContextType context, @Nullable
// Context parent) {
//
...
// }
//
// @SuppressWarnings("null") Map<String, Let> lets = letStream
// .collect(CustomCollectors.toMap(
// Let::getName,
// Function.identity(),
// (key, v1, v2) -> {
// if (LOGGER.isWarnEnabled()) {
// LOGGER.warn("Let expressions '{}' and '{}' have duplicate names '{}'. Using
// the second.",
...
// */
// @NonNull
// protected MetaschemaMetaConstraintsDocument parseConstraintSet(@NonNull URI
...
// return
// ObjectUtils.notNull(MetaschemaMetaConstraintsDocument.Factory.parse(resource.toURL(),
// options));
