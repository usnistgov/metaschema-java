 ...
 */
public final class ExternalModelSource implements ISource {
  @NonNull
  ...
  /**
   * Get a new instance of a model source associated with a resource
   * {@code location}.
   *
   * @param location
  ...
  ExternalModelSource(@NonNull URI modelSource) {
