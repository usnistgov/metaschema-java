...
public interface IGroupedModelContainer extends IContainer {
  /**
   ...
   */
  @NonNull
  Collection<? extends IGroupedNamedModelInstance> getNamedModelInstances();
   ...
   */
  @Nullable
  IGroupedNamedModelInstance getNamedModelInstanceByName(String name);
   ...
   */
  @NonNull
  Collection<? extends IGroupedFieldInstance> getFieldInstances();
   ...
   */
  @Nullable
  IGroupedFieldInstance getFieldInstanceByName(String name);
   ...
   */
  @NonNull
  Collection<? extends IGroupedAssemblyInstance> getAssemblyInstances();
   ...
   */
  @Nullable
  IGroupedAssemblyInstance getAssemblyInstanceByName(String name);
}
