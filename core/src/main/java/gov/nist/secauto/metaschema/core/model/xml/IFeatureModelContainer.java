...
interface IFeatureModelContainer extends IFeatureFlagContainer, IModelContainer {
  /**
   ...
   */
  @NonNull
  XmlModelContainerSupport getModelContainer();
  ...
  @Override
  default @NonNull Collection<? extends INamedModelInstance> getNamedModelInstances() {
  ...
  @SuppressWarnings("null")
  @Override
  default Collection<? extends IFieldInstance> getFieldInstances() {
  ...
  @SuppressWarnings("null")
  @Override
  default Collection<? extends IAssemblyInstance> getAssemblyInstances() {
    return getModelContainer().getAssemblyInstanceMap().values();
  }

  @Override
  default List<? extends IChoiceInstance> getChoiceInstances() {
    return getModelContainer().getChoiceInstances();
  }

  @Override
  default List<? extends IModelInstance> getModelInstances() {
