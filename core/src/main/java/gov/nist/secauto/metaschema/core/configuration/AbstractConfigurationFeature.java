...
/**
 * Provides a complete, abstract implementation of a generalized feature. Feature implementations
 * can extend this class the implement configuration sets for a given purpose.
 *
 * @param <V>
