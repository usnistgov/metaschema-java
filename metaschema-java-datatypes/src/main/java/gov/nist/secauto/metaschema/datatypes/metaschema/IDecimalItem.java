...
public interface IDecimalItem extends INumericItem {
  ...
  public static IDecimalItem valueOf(double value) {
    return valueOf(BigDecimal.valueOf(value));
  }

  public static IDecimalItem valueOf(BigDecimal value) {
    return value == null ? null : new DecimalItem(value);
  }

  public static IDecimalItem valueOf(String value) {
    IDecimalItem retval;
    if (value == null) {
      retval = null;
      ...
      retval = valueOf(new BigDecimal(value, MathContext.DECIMAL64));
    }
    return retval;
  }
}
