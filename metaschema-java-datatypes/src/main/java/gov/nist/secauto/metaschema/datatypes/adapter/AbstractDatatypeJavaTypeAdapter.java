 ...
 * 
 * @param <TYPE>
 *          the Java type this adapter supports, which is based on {@link Datatype}
 */
public abstract class AbstractDatatypeJavaTypeAdapter<TYPE extends Datatype<TYPE>>
    extends AbstractJavaTypeAdapter<TYPE> {

  /**
   * Construct a new Java type adapter for the class based on {@link Datatype}.
   * 
   * @param clazz
   *          a data type class based on {@link Datatype}
   */
