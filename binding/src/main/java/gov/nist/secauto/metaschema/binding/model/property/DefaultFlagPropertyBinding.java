...
public class DefaultFlagPropertyBinding extends AbstractPropertyBinding implements FlagPropertyBinding {
  ...
  public DefaultFlagPropertyBinding(PropertyInfo propertyInfo, Flag flagAnnotation, boolean isJsonKey,
    ...
    // String resolvedNamespace = ModelUtil.resolveNamespace(getFlagAnnotation().namespace(),
    // getPropertyInfo().getContainingClass());
