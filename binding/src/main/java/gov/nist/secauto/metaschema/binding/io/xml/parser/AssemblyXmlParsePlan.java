...
public class AssemblyXmlParsePlan<CLASS> extends AbstractXmlParsePlan<CLASS, AssemblyClassBinding<CLASS>> {
	...
	public AssemblyXmlParsePlan(AssemblyClassBinding<CLASS> classBinding, BindingContext bindingContext) throws BindingException {
		this(classBinding, newXmlAttributeParsers(classBinding, bindingContext), newModelParsers(classBinding, bindingContext));
	}

	public AssemblyXmlParsePlan(AssemblyClassBinding<CLASS> classBinding, Map<QName, XmlAttributePropertyParser> attributeParsers, List<XmlObjectPropertyParser> modelParsers) {
