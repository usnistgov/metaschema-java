...
//				then(readerState.is(CHARACTERS));
		...
		AbstractXmlParsePlan<Value, ClassBinding<Value>> parsePlan = new AbstractXmlParsePlan<>(classBinding, Collections.emptyMap()) {
...
//				// parsing object START_ELEMENT
		...
		AbstractXmlParsePlan<Value, ClassBinding<Value>> parsePlan = new AbstractXmlParsePlan<>(classBinding, attributeParsers) {
