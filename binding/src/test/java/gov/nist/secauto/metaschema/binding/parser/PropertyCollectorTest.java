...
import gov.nist.secauto.metaschema.binding.property.PropertyCollector;
...
class PropertyCollectorTest {
	...
	void testSingleton() throws NoSuchFieldException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, BindingException {
		...
		FieldPropertyBinding binding = FieldPropertyBinding.fromJavaField(field, field.getAnnotation(gov.nist.secauto.metaschema.binding.annotations.Field.class));
	...
	private static class TestClass {
		@gov.nist.secauto.metaschema.binding.annotations.Field
