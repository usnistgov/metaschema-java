...
public class ASTPrinter extends AbstractExpressionVisitor<String, Void> {
  ...
  @Override
  protected String visitChildren(Expression expr, Void context) {
    indentation++;
  ...
  protected String appendNode(Expression expr, String childResult) {
    StringBuilder buffer = new StringBuilder();
    buffer.append(getIndentation());
  ...
  @Override
  public String visitAxisStep(AxisStep expr, Void context) {
    return appendNode(expr, super.visitAxisStep(expr, context));
  }
  ...
  @Override
  public String visitDoubleSlashPath(DoubleSlashPath expr, Void context) {
    return appendNode(expr, super.visitDoubleSlashPath(expr, context));
  }
  ...
  @Override
  public String visitPostfix(PostfixExpr expr, Void context) {
    return appendNode(expr, super.visitPostfix(expr, context));
  }

  @Override
  public String visitRelativePath(RelativePath expr, Void context) {
    return appendNode(expr, super.visitRelativePath(expr, context));
  }

  @Override
  public String visitSlashOnlyPath(SlashOnlyPath expr, Void context) {
    return appendNode(expr, super.visitSlashOnlyPath(expr, context));
  }

  @Override
  public String visitSlashPath(SlashPath expr, Void context) {
    return appendNode(expr, super.visitSlashPath(expr, context));
  }
  ...
  @Override
  public String visitTextTest(TextTest expr, Void context) {
    return appendNode(expr, super.visitTextTest(expr, context));
  }
  ...
  @Override
  public String visitWildcard(WildcardExpr expr, Void context) {
