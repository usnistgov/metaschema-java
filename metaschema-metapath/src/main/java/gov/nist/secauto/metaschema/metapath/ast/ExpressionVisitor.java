...
public interface ExpressionVisitor<RESULT, CONTEXT> {
  ...
  RESULT visit(Expression expr, CONTEXT context);

  RESULT visitAddition(Addition expr, CONTEXT context);

  RESULT visitAnd(And expr, CONTEXT context);

  RESULT visitAxisStep(AxisStep expr, CONTEXT context);
  ...
  RESULT visitDoubleSlashPath(DoubleSlashPath expr, CONTEXT context);
  ...
  RESULT visitPostfix(PostfixExpr expr, CONTEXT context);

  RESULT visitRelativePath(RelativePath expr, CONTEXT context);

  RESULT visitSlashOnlyPath(SlashOnlyPath expr, CONTEXT context);

  RESULT visitSlashPath(SlashPath expr, CONTEXT context);
  ...
  RESULT visitTextTest(TextTest expr, CONTEXT context);

  RESULT visitUnion(Union expr, CONTEXT context);

  RESULT visitWildcard(WildcardExpr expr, CONTEXT context);
