...
public abstract class AbstractCollectionPropertyInfo<TYPE extends Type> extends BasicPropertyInfo<TYPE>
	...
	public String getGroupLocalName() {
		return getGroupAs() != null ? ModelUtil.resolveLocalName(getGroupAs().name(), getPropertyAccessor()) : null;
	}

	@Override
	public String getGroupNamespace() throws BindingException {
		return getGroupAs() != null ? ModelUtil.resolveNamespace(getGroupAs().namespace(), getPropertyAccessor()) : null;
	}
