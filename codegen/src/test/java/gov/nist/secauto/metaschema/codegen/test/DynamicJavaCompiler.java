...
public class DynamicJavaCompiler {
	private static final Logger logger = LogManager.getLogger(DynamicJavaCompiler.class);
	...
	public static void main(String[] args)
		...
		DynamicJavaCompiler compiler = new DynamicJavaCompiler(new File("target/generated-classes/dynamic"));
	...
	public DynamicJavaCompiler(File compilationLocation) {
