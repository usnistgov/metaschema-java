...
public class ValidatingXdmVisitor extends AbstractXdmNodeItemVisitor<Boolean, DefaultConstraintValidator> {
  ...
  @Override
  public Boolean visitFlag(IBoundXdmFlagNodeItem item, DefaultConstraintValidator context) {
    context.validate(item);
    return super.visitFlag(item, context);
  }

  @Override
  public Boolean visitField(IBoundXdmFieldNodeItem item, DefaultConstraintValidator context) {
    context.validate(item);
    return super.visitField(item, context);
  }

  @Override
  public Boolean visitAssembly(IBoundXdmAssemblyNodeItem item, DefaultConstraintValidator context) {
    context.validate(item);
