...
public class DefaultConstraintValidator implements ConstraintValidator {
  ...
  @Override
  public void validate(IBoundXdmFlagNodeItem item) {
    FlagDefinition definition = item.getDefinition();
  ...
  @Override
  public void validate(IBoundXdmFieldNodeItem item) {
    FieldDefinition definition = item.getDefinition();
  ...
  @Override
  public void validate(IBoundXdmAssemblyNodeItem item) {
    AssemblyDefinition definition = item.getDefinition();
  ...
  protected void validateHasCardinality(List<? extends ICardinalityConstraint> constraints,
      List<? extends IAssemblyNodeItem> items) {
  ...
  protected void validateHasCardinality(List<? extends ICardinalityConstraint> constraints, IAssemblyNodeItem item) {
  ...
  protected void validateHasCardinality(ICardinalityConstraint constraint, IAssemblyNodeItem node,
  ...
  protected void validateIndex(List<? extends IIndexConstraint> constraints, List<? extends IAssemblyNodeItem> items) {
  ...
  protected void validateIndex(List<? extends IIndexConstraint> constraints, IAssemblyNodeItem item) {
  ...
  protected void validateIndex(IIndexConstraint constraint, IAssemblyNodeItem node, ISequence<?> targets) {
  ...
  protected void validateUnique(List<? extends IUniqueConstraint> constraints,
      List<? extends IAssemblyNodeItem> items) {
  ...
  protected void validateUnique(List<? extends IUniqueConstraint> constraints, IAssemblyNodeItem item) {
  ...
  protected void validateUnique(IUniqueConstraint constraint, @SuppressWarnings("unused") IAssemblyNodeItem node,
      ISequence<?> targets) {
