...
public interface JsonProblemHandler extends ProblemHandler {
  boolean handleUnknownRootProperty(Object instance, AssemblyClassBinding classBinding, String fieldName,
   ...
   */
  Map<Property, JsonBindingSupplier> handleMissingFields(ClassBinding classBinding,
