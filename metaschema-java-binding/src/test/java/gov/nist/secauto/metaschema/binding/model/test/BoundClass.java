...
public class BoundClass {
  ...
  public String getSingleSimpleField() {
    return singleSimpleField;
  }

  public void setSingleSimpleField(String value) {
    this.singleSimpleField = value;
  }

  public List<String> getGroupedListSimpleField() {
    return groupedListSimpleField;
  }

  public void setGroupedListSimpleField(List<String> value) {
    this.groupedListSimpleField = value;
  }

  public BoundClass.FlaggedField getSingleFlaggedField() {
    return singleFlaggedField;
  }

  public void setSingleFlaggedField(BoundClass.FlaggedField value) {
    this.singleFlaggedField = value;
  }

  public List<BoundClass.FlaggedField> getGroupedListField() {
    return groupedListField;
  }

  public void setGroupedListField(List<BoundClass.FlaggedField> value) {
    this.groupedListField = value;
  }

  public List<BoundClass.FlaggedField> getUngroupedListField() {
    return ungroupedListField;
  }

  public void setUngroupedListField(List<BoundClass.FlaggedField> value) {
    this.ungroupedListField = value;
  }

  public Map<String, BoundClass.KeyedField> getMappedField() {
    return mappedField;
  }

  public void setMappedField(Map<String, BoundClass.KeyedField> value) {
    this.mappedField = value;
  }

  public FlaggedAssemblyClass getSingleFlaggedAssembly() {
    return singleFlaggedAssembly;
  }

  public void setSingleFlaggedAssembly(FlaggedAssemblyClass singleFlaggedAssembly) {
