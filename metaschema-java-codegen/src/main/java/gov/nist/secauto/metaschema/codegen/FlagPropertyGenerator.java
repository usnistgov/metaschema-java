...
public class FlagPropertyGenerator extends AbstractPropertyGenerator<AbstractClassGenerator<?>> {
  ...
  public FlagPropertyGenerator(FlagInstance instance, AbstractClassGenerator<?> classContext) {
    super(classContext);
  ...
  public boolean isJsonValueKeyFlag() {
    ...
    return parentField.hasJsonValueKey() && JsonValueKeyEnum.FLAG.equals(parentField.getJsonValueKeyType())
        && getInstance().equals(parentField.getJsonValueKeyFlagInstance());
  }
  ...
  protected void buildField(FieldBuilder builder) {
    ...
    if (parent instanceof FieldDefinition && isJsonValueKeyFlag()) {
