...
public class SingletonPropertyValueHandler extends AbstractPropertyValueHandler {
  ...
  public SingletonPropertyValueHandler(ClassBinding<?> classBinding, PropertyItemHandler propertyItemHandler) {
  ...
  public boolean parseNextFieldValue(JsonParsingContext parsingContext) throws BindingException, IOException {
    ...
    if (values == null) {
      throw new BindingException(
          String.format("Expected a singleton value for property '%s' on class '%s', but no value was parsed.",
