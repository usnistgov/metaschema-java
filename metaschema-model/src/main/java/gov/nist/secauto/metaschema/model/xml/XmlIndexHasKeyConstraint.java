...
public class XmlIndexHasKeyConstraint extends AbstractIndexHasKeyConstraint {
  ...
  public XmlIndexHasKeyConstraint(IndexConstraintType xmlConstraint) {
    this.id = xmlConstraint.isSetId() ? xmlConstraint.getId() : null;
    this.indexName = xmlConstraint.getName();
