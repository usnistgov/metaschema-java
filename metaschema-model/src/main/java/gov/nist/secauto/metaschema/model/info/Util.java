...
public class Util {
  public static String toCoordinates(InfoElementInstance instance) {
    return String.format("%s:%s:%s@%d(%d)", instance.getContainingMetaschema().getShortName(), instance.getType(),
        instance.getName(), instance.hashCode(), instance.isReference() ? instance.getDefinition().hashCode() : 0);
  }
