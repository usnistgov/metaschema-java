...
import gov.nist.secauto.metaschema.model.common.constraint.AbstractExpectConstraint;
...
public class XmlExpectConstraint extends AbstractExpectConstraint {

  public XmlExpectConstraint(ScopedExpectConstraintType xmlConstraint) {
    this(xmlConstraint, xmlConstraint.getTarget());
  }

  public XmlExpectConstraint(ExpectConstraintType xmlConstraint, MetapathExpression target) {
    super(xmlConstraint.isSetId() ? xmlConstraint.getId() : null, target == null ? IConstraint.DEFAULT_TARGET : target,
