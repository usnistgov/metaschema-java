...
import gov.nist.secauto.metaschema.model.common.constraint.AbstractUniqueConstraint;
...
public class XmlUniqueConstraint extends AbstractUniqueConstraint<DefaultKeyField> {

  public XmlUniqueConstraint(ScopedKeyConstraintType xmlConstraint) {
