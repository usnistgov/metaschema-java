...
public class XmlIndexConstraint extends AbstractIndexConstraint<DefaultKeyField> {

  public XmlIndexConstraint(ScopedIndexConstraintType xmlConstraint) {
    super(xmlConstraint.isSetId() ? xmlConstraint.getId() : null, xmlConstraint.getTarget(), xmlConstraint.getName(),
