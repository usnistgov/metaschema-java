...
import gov.nist.secauto.metaschema.model.common.constraint.AbstractCardinalityConstraint;
...
public class XmlCardinalityConstraint extends AbstractCardinalityConstraint {

  public XmlCardinalityConstraint(HasCardinalityConstraintType xmlConstraint) {
    super(xmlConstraint.isSetId() ? xmlConstraint.getId() : null, xmlConstraint.getTarget(),
