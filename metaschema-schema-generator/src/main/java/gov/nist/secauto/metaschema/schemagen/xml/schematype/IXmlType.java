...
public interface IXmlType {
   ...
   * Get the type's name.
   * <p>
   * This is a shortcut to calling {@link #getQName()}.{@link QName#getLocalPart()}.
   * 
  ...
  /**
   * Get the type name for use as a type reference. This type is namespace prefixed when needed.
   * 
   * @return the type name
   */
  @NonNull
   ...
   * @param anonymous
   *          {@code true} if the type should not have a name, or {@code false} if a name is required
   * @throws SchemaGenerationException
   *           if an error occurred while writing the type
   */
  void generateType(@NonNull XmlGenerationState state, boolean anonymous);

  /**
   * Determine if the type should be generated inline.
   * 
   * @param state
   *          the schema generation state used for context
   * @return {@code true} if the type should generated inline or {@code false} otherwise
   */
   ...
   * @param state
   *          the schema generation state used for context
   * @return {@code true} if the type is generated by the schema generator or {@code false} otherwise
   */
