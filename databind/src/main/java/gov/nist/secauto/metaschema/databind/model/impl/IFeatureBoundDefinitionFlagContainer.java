 ...
 * implementation.
 */
public interface IFeatureBoundDefinitionFlagContainer extends IBoundDefinitionModel {
  /**
   ...
   */
  @NonNull
  IBoundDefinitionFlagContainerSupport getFlagContainer();
  ...
  @Override
  @NonNull
  default Collection<IBoundInstanceFlag> getFlagInstances() {
    return ObjectUtils.notNull(getFlagContainer().getFlagInstanceMap().values());
  }

  @Override
  @Nullable
  default IBoundInstanceFlag getJsonKeyFlagInstance() {
