...
import gov.nist.secauto.metaschema.databind.model.oldmodel.IBoundFieldDefinition;
...
public class SimpleFieldPropertyImpl
  ...
  public SimpleFieldPropertyImpl(
    ...
    BoundField boundField = getBindingAnnotation();
    ...
    this.instanceDefaultValue
        = ModelUtil.resolveDefaultValue(getBindingAnnotation().defaultValue(), this.javaTypeAdapter);
  }
  ...
  private final class ScalarFieldDefinition
    ...
    private ScalarFieldDefinition() {
      this.constraints = ObjectUtils.notNull(Lazy.lazy(() -> {
        ...
        ValueConstraints valueAnnotation = getBindingAnnotation().valueConstraints();
