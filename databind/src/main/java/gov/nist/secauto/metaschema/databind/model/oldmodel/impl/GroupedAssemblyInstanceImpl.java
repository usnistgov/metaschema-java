...
public class GroupedAssemblyInstanceImpl
    extends AbstractBoundGroupedNamedModelInstance<IAssemblyClassBinding>
    implements IBoundGroupedAssemblyInstance {

  public GroupedAssemblyInstanceImpl(
      @NonNull ChoiceGroupProperty containingChoice,
      @NonNull BoundChoiceGroup.ModelInstance annotation) {
    super(containingChoice, annotation, IAssemblyClassBinding.class);
  }
