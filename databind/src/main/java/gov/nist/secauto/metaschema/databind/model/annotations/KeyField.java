...
public @interface KeyField {
   ...
   * the value of the {@link BoundFlag}, {@link BoundField} or {@link FieldValue}
   * annotation the constraint appears on. In the prior case, this annotation may
   * only appear on a {@link BoundField} if the field has no flags, which results
   * in a {@link BoundField} annotation on a field instance with a scalar, data
   * type value.
   *
