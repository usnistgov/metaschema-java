...
public interface IBindingStrategyFactory {
  /**
   * Construct a new class binding strategy for the Metaschema definition
   * associated with the provided Java class.
   * <p>
   ...
   */
  @NonNull
  IClassBindingStrategy<?> newClassBindingStrategy(Class<?> clazz);
}
