...
/**
 * Provides a common interface to read, write, and copy items of a given type.
 */
public interface IItemValueHandler {
  ...
  /**
   * Indicate if the item supported by this handler allows JSON keys.
   *
   * @return {@code true} if the underlying data type is allowed to have a JSON
   *         key, or {@code false} otherwise
   */
   ...
   */
  @NonNull
  Object deepCopy(@NonNull Object source, @Nullable Object parentInstance) throws BindingException;
}
