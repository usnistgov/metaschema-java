...
public abstract class AbstractBoundGroupedFieldInstance implements IBoundGroupedFieldInstance {
  @NonNull
  private final BoundGroupedField annotation;
  @NonNull
  private final IBoundChoiceGroupInstance container;

  protected AbstractBoundGroupedFieldInstance(
   ...
   */
  protected BoundGroupedField getAnnotation() {
    return annotation;
  }
