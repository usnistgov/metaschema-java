...
import gov.nist.secauto.metaschema.databind.model.IBoundContainerModel;
...
public interface IFeatureBoundDefinitionModelContainer<
   ...
   */
  @NonNull
  IBoundDefinitionModelContainerSupport<MI, NMI, FI, AI, CGI> getModelContainer();
