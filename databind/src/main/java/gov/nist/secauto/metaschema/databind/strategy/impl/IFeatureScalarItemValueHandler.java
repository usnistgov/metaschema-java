...
public interface IFeatureScalarItemValueHandler extends IItemValueHandler {
  /**
  ...
  @Override
  default Object deepCopy(Object source, Object parentInstance) throws BindingException {
