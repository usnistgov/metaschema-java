 ...
 */
public interface IFeatureBindingContainerFlag
    extends IFeatureContainerFlag<IBindingInstanceFlag>, IBindingDefinitionModel {

  @Override
  @NonNull
  IContainerFlagSupport<IBindingInstanceFlag> getFlagContainer();
  ...
  @Override
  @NonNull
  default Collection<IBindingInstanceFlag> getFlagInstances() {
