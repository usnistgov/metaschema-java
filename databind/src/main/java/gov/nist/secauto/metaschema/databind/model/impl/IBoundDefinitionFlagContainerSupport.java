...
public interface IBoundDefinitionFlagContainerSupport {
  @NonNull
  EmptyFlagContainer EMPTY = new EmptyFlagContainer();
   ...
   */
  @NonNull
  static IBoundDefinitionFlagContainerSupport empty() {
    return EMPTY;
  }
   ...
   */
  @NonNull
  Map<String, IBoundInstanceFlag> getFlagInstanceMap();
  ...
  class EmptyFlagContainer implements IBoundDefinitionFlagContainerSupport {
