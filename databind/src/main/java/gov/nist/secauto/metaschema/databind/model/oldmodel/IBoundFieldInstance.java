...
package gov.nist.secauto.metaschema.databind.model.oldmodel;

import gov.nist.secauto.metaschema.core.model.IFieldInstance;
import gov.nist.secauto.metaschema.databind.IBindingContext;
import gov.nist.secauto.metaschema.databind.model.IAssemblyClassBinding;
import gov.nist.secauto.metaschema.databind.model.IClassBinding;
import gov.nist.secauto.metaschema.databind.model.oldmodel.impl.ClassBindingFieldPropertyImpl;
import gov.nist.secauto.metaschema.databind.model.oldmodel.impl.SimpleFieldPropertyImpl;
...
public interface IBoundFieldInstance extends IBoundNamedModelInstance, IFieldInstance {
  ...
  static IBoundFieldInstance newInstance(
    ...
    IClassBinding classBinding = bindingContext.getClassBindingStrategy(itemType);
