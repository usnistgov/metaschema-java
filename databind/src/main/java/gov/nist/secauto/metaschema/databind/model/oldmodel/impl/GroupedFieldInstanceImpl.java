...
public class GroupedFieldInstanceImpl
    extends AbstractBoundGroupedNamedModelInstance<IFieldClassBinding>
    implements IBoundGroupedFieldInstance {

  public GroupedFieldInstanceImpl(
      @NonNull ChoiceGroupProperty containingChoice,
      @NonNull BoundChoiceGroup.ModelInstance annotation) {
    super(containingChoice, annotation, IFieldClassBinding.class);
  }
