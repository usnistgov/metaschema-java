...
import gov.nist.secauto.metaschema.model.common.metapath.FailingErrorListener;
...
class BuildAstVisitorTest {
  ...
  private static IExpression parseExpression(@NotNull String path) {
    ...
    IExpression retval = new BuildAstVisitor().visit(tree);
//    System.out.println(ASTPrinter.instance().visit(retval));
    return retval;
  }
