...
public class String implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .returnOne()
      .functionHandler(new String())
      .build();

  @Override
  public ISequence<IStringItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToString(argItem));
  }
}
