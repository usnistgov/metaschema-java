...
class DateTimeWithoutTimeZoneItemImpl extends AbstractAnyAtomicItem<DateTime> implements IDateTimeItem {

  public DateTimeWithoutTimeZoneItemImpl(DateTime value) {
    super(value);
  }
