...
public final class CastToPositiveIntegerFunction {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .argument(IArgument.newBuilder()
          ...
          .one()
          .build())
      .returnType(IPositiveIntegerItem.class)
      .returnOne()
      .functionHandler(CastToPositiveIntegerFunction::execute)
      .build();

  private CastToPositiveIntegerFunction() {
    // disable construction
  }

  @NotNull
  public static ISequence<IPositiveIntegerItem> execute(@NotNull IFunction function,
    ...
    IPositiveIntegerItem castItem = castToPositiveInteger(item);
    return ISequence.of(castItem);
  }

  @NotNull
  public static IPositiveIntegerItem castToPositiveInteger(@NotNull IAnyAtomicItem item)
      throws InvalidValueForCastFunctionMetapathException {
    return IPositiveIntegerItem.cast(item);
  }
}
