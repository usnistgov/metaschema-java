...
import gov.nist.secauto.metaschema.model.common.datatype.adapter.INonNegativeIntegerItem;
...
public class CastToNonNegativeInteger {
  ...
  public static ISequence<INonNegativeIntegerItem> execute(@NotNull IFunction function,
    ...
    INonNegativeIntegerItem castItem = castToNonNegativeInteger(item);
    return ISequence.of(castItem);
  }

  @NotNull
  public static INonNegativeIntegerItem castToNonNegativeInteger(@NotNull IAnyAtomicItem item)
      throws InvalidValueForCastFunctionMetapathException {
    return INonNegativeIntegerItem.cast(item);
  }
}
