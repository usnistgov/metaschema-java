...
class UriReferenceItemImpl extends AbstractAnyAtomicItem<URI> implements IUriReferenceItem {

  public UriReferenceItemImpl(URI value) {
    super(value);
  }

  @Override
  public IUriReferenceType getItemType() {
    return TypeFactory.URI_REFERENCE_TYPE;
  }
