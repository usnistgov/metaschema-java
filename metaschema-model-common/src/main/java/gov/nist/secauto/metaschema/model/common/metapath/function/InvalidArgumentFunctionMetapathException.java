...
public class InvalidArgumentFunctionMetapathException
  ...
  public InvalidArgumentFunctionMetapathException(int code, String message, Throwable cause) {
    super(code, message, cause);
  }

  public InvalidArgumentFunctionMetapathException(int code, String message) {
    super(code, message);
  }

  public InvalidArgumentFunctionMetapathException(int code, Throwable cause) {
    super(code, cause);
  }
