...
public abstract class ModelWalker<DATA> {
   ...
   */
  public void walk(IFlagDefinition flag) {
    walk(flag, null);
  }
   ...
   */
  public void walk(IFieldDefinition field) {
    walk(field, null);
  }
  ...
  public void walk(IFieldDefinition field, DATA data) {
    if (visit(field, data)) {
      walkFlagInstances(field.getFlagInstances().values(), data);
    }
  }
   ...
   */
  public void walk(IAssemblyDefinition assembly) {
    walk(assembly, null);
  }
  ...
  public void walk(IAssemblyDefinition assembly, DATA data) {
    if (visit(assembly, data)) {
      walkFlagInstances(assembly.getFlagInstances().values(), data);
   ...
   */
  public void walk(IFlagInstance instance, DATA data) {
   ...
   */
  public void walk(IFieldInstance instance, DATA data) {
    if (visit(instance, data)) {
      walk(instance.getDefinition(), data);
    }
  }
   ...
   */
  public void walk(IAssemblyInstance instance, DATA data) {
    if (visit(instance, data)) {
      walk(instance.getDefinition(), data);
    }
  }
   ...
   */
  public void walk(IChoiceInstance instance, DATA data) {
    if (visit(instance, data)) {
   ...
   */
  protected void walkFlagInstances(Collection<? extends IFlagInstance> instances, DATA data) {
   ...
   */
  protected void walkModelInstances(Collection<? extends IModelInstance> instances, DATA data) {
   ...
   */
  protected void walkModelInstance(IModelInstance instance, DATA data) {
