...
public final class CastToIntegerFunction {
  ...
  public static ISequence<IIntegerItem> execute(@NotNull IFunction function,
    ...
    IIntegerItem integer = castToInteger(item);
    return ISequence.of(integer);
  }

  @NotNull
  public static IIntegerItem castToInteger(@NotNull IAnyAtomicItem item)
      throws InvalidValueForCastFunctionMetapathException {
    return IIntegerItem.cast(item);
  }
}
