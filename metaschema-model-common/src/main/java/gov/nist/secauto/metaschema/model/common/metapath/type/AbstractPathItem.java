...
public abstract class AbstractPathItem implements IPathItem {
  private final IPathSegment segment;


  public AbstractPathItem(IPathSegment segment) {
    Objects.requireNonNull(segment, "segment");
    this.segment = segment;
  }

  @Override
  public IPathSegment getPathSegment() {
    return segment;
  }
