...
public interface INonNegativeIntegerItem extends IIntegerItem {
  ...
  public static INonNegativeIntegerItem valueOf(IIntegerItem value) {
  ...
  public static INonNegativeIntegerItem valueOf(BigInteger value) {
    return value == null ? null : new NonNegativeIntegerItemImpl(value);
  }

  public static INonNegativeIntegerItem valueOf(String value) {
    INonNegativeIntegerItem retval;
    if (value == null) {
      retval = null;
    } else if (value.isBlank()) {
      retval = null;
    } else {
      retval = valueOf(new BigInteger(value));
    }
    return retval;
  }
}
