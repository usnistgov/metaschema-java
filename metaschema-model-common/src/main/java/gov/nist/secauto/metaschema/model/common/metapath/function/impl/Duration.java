...
public class Duration implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .argument(IArgument.newBuilder()
          ...
          .one()
          .build())
      .returnType(IDurationItem.class)
      .returnOne()
      .functionHandler(new Duration())
      .build();

  @Override
  public ISequence<IDurationItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToDuration(argItem));
  }
}
