...
public interface IStringItem extends IAnyAtomicItem {
  @NotNull
  public static IStringItem valueOf(@NotNull String string) {
    return MetaschemaDataTypeProvider.STRING.newItem(string);
  }

  @NotNull
  public static IStringItem cast(@NotNull IAnyAtomicItem item) throws InvalidValueForCastFunctionMetapathException {
