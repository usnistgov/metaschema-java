...
public class NcName implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .returnOne()
      .functionHandler(new NcName())
      .build();

  @Override
  public ISequence<INcNameItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToNcName(argItem));
  }
}
