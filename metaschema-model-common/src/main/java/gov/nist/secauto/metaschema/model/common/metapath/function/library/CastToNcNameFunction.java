...
public final class CastToNcNameFunction {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .argument(IArgument.newBuilder()
          ...
          .one()
          .build())
      .returnType(INcNameItem.class)
      .returnOne()
      .functionHandler(CastToNcNameFunction::execute)
      .build();

  private CastToNcNameFunction() {
    // disable construction
  }

  @NotNull
  public static ISequence<INcNameItem> execute(@NotNull IFunction function,
    ...
    INcNameItem castItem = castToNcName(item);
    return ISequence.of(castItem);
  }

  @NotNull
  public static INcNameItem castToNcName(@NotNull IAnyAtomicItem item)
      throws InvalidValueForCastFunctionMetapathException {
    return INcNameItem.cast(item);
  }
}
