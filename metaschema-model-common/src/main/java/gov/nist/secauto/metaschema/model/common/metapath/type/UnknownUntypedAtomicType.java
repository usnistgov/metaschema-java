...
public class UnknownUntypedAtomicType implements IUntypedAtomicType {
  ...
  public UnknownUntypedAtomicType(DataTypes dataType) {
  ...
  @Override
  public IUntypedAtomicItem newItem(Object value) {
    Object item = getDataType().getJavaTypeAdapter().toValue(value);
  ...
  public class UnknownUntypedAtomicItem extends AbstractUntypedAtomicItem<Object> {
    ...
    @Override
    public IAnyAtomicType getItemType() {
      return UnknownUntypedAtomicType.this;
    }

    @Override
    public IUntypedAtomicItem toAtomicItem() {
      return this;
    }
  }
}
