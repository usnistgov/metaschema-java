...
public class FnResolveUriFunction {
  static final IFunction SIGNATURE_ONE_ARG = IFunction.newBuilder()
      ...
      .returnZeroOrOne()
      .functionHandler(FnResolveUriFunction::executeOneArg)
      .build();
  ...
  static final IFunction SIGNATURE_TWO_ARG = IFunction.newBuilder()
      ...
      .returnType(IAnyUriItem.class)
      .returnZeroOrOne()
      .functionHandler(FnResolveUriFunction::executeTwoArg)
      .build();
  ...
  public static IAnyUriItem fnResolveUri(IStringItem relative, IAnyUriItem baseUri) {
    ...
    return fnResolveUri(relativeUri, baseUri);
  }

  public static IAnyUriItem fnResolveUri(IStringItem relative, IStringItem base) {
    IAnyUriItem relativeUri = relative == null ? null : IAnyUriItem.cast(relative);
    IAnyUriItem baseUri = base == null ? null : IAnyUriItem.cast(base);

    return fnResolveUri(relativeUri, baseUri);
  }

  public static IAnyUriItem fnResolveUri(IAnyUriItem relativeUri, IAnyUriItem baseUri) {
    if (relativeUri == null) {
      return null;
    }
