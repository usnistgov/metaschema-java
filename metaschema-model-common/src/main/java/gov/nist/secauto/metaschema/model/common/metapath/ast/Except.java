...
public class Except extends AbstractBinaryExpression<IExpression, IExpression> {

  @NotNull
  private final Class<? extends IItem> staticResultType;
  
  @SuppressWarnings("null")
  public Except(@NotNull IExpression left, @NotNull IExpression right) {
    super(left, right);
  ...
  public ISequence<? extends IItem> accept(@NotNull DynamicContext dynamicContext,
    ...
    return ISequence.of(left.asStream()
      .filter(item -> !rightList.contains(item)));
  }
