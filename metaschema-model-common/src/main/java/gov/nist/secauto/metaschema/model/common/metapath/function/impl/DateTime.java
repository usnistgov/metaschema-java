...
public class DateTime implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .returnOne()
      .functionHandler(new DateTime())
      .build();

  @Override
  public ISequence<IDateTimeItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToDateTime(argItem));
  }
}
