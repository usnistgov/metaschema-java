...
public class Decimal implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .argument(IArgument.newBuilder()
          ...
          .one()
          .build())
      .returnType(IDecimalItem.class)
      .returnOne()
      .functionHandler(new Decimal())
      .build();

  @Override
  public ISequence<IDecimalItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToDecimal(argItem));
  }
}
