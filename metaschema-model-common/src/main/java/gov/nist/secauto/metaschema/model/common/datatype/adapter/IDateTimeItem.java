...
public interface IDateTimeItem extends IAnyAtomicItem {
  ...
  @NotNull
  public static IDateTimeItem valueOf(@NotNull DateTime value) {
    return MetaschemaDataTypeProvider.DATE_TIME.newItem(value);
  }

  @NotNull
  public static IDateTimeItem valueOf(@NotNull ZonedDateTime value) {
    return MetaschemaDataTypeProvider.DATE_TIME_WITH_TZ.newItem(value);
  }
  ...
  @NotNull
  public static IDateTimeItem cast(@NotNull IAnyAtomicItem item) {
