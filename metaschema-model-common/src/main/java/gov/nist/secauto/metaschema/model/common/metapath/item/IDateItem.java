...
public interface IDateItem extends IAnyAtomicItem {
  ...
  public static IDateItem valueOf(Date value) {
    return new DateWithoutTimeZoneItemImpl(value);
  }

  public static IDateItem valueOf(ZonedDateTime value) {
    return new DateWithTimeZoneItemImpl(value);
  }

  public static IDateItem valueOf(String value) throws IllegalArgumentException {
