...
public interface IPositiveIntegerItem extends IIntegerItem {
  ...
  public static IPositiveIntegerItem valueOf(IIntegerItem value) {
  ...
  public static IPositiveIntegerItem valueOf(BigInteger value) {
    return value == null ? null : new PositiveIntegerItemImpl(value);
  }

  public static IPositiveIntegerItem valueOf(String value) {
    IPositiveIntegerItem retval;
    if (value == null) {
      retval = null;
