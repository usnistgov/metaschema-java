...
class MarkupMultiLineItemImpl extends AbstractMarkupItem<MarkupMultiline> implements IMarkupItem {

  public MarkupMultiLineItemImpl(MarkupMultiline value) {
    super(value);
  }

  @Override
  public IMarkupType getItemType() {
    return TypeFactory.MARKUP_MULTILINE_TYPE;
  }
