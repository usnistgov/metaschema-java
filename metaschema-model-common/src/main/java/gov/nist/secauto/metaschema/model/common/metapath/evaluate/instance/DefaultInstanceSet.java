...
public class DefaultInstanceSet implements IInstanceSet {
  private List<? extends IInstance> instances;

  public DefaultInstanceSet(List<? extends IInstance> instances) {
