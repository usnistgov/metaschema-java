...
public final class CastToStringFunction {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .argument(IArgument.newBuilder()
          .name("arg1").type(IAnyAtomicItem.class)
          .one()
          .build())
  ...
  public static ISequence<IStringItem> execute(@NotNull IFunction function,
    ...
    IStringItem castItem = castToString(item);
    return ISequence.of(castItem);
  }

  @NotNull
  public static IStringItem castToString(@NotNull IAnyAtomicItem item)
      throws InvalidValueForCastFunctionMetapathException {
    return IStringItem.cast(item);
  }
}
