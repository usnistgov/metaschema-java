...
public interface INcNameItem extends IStringItem {
  @NotNull
  public static INcNameItem valueOf(@NotNull String string) {
    return MetaschemaDataTypeProvider.NCNAME.newItem(string);
  }

  @NotNull
  public static INcNameItem cast(@NotNull IAnyAtomicItem item) throws InvalidValueForCastFunctionMetapathException {
