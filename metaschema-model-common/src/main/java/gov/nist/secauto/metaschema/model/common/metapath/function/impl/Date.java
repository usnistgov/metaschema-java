...
public class Date implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .argument(IArgument.newBuilder()
          ...
          .one()
          .build())
      .returnType(IDateItem.class)
      .returnOne()
      .functionHandler(new Date())
      .build();

  @Override
  public ISequence<IDateItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToDate(argItem));
  }
}
