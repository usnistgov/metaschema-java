...
public class AssemblyDefinitionPathSegment implements IPathSegment {
  private final IAssemblyDefinition definition;

  public AssemblyDefinitionPathSegment(IAssemblyDefinition definition) {
    this.definition = definition;
  }

  @Override
  public INamedInstance getInstance() {
    throw new UnsupportedOperationException("not an instance");
  }
