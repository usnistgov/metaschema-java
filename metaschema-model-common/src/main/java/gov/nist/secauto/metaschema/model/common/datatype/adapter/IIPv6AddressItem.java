...
public interface IIPv6AddressItem extends IIPAddressItem {
  ...
  @NotNull
  public static IIPv6AddressItem valueOf(@NotNull IPv6Address item) {
    return MetaschemaDataTypeProvider.IP_V6_ADDRESS.newItem(item);
  }

  @NotNull
  public static IIPv6AddressItem cast(@NotNull IAnyAtomicItem item) throws InvalidValueForCastFunctionMetapathException {
