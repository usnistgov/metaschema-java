...
public interface IDateTimeItem extends IAnyAtomicItem {
  ...
  public static IDateTimeItem valueOf(DateTime value) {
    return new DateTimeWithoutTimeZoneItemImpl(value);
  }

  public static IDateTimeItem valueOf(ZonedDateTime value) {
    return new DateTimeWithTimeZoneItemImpl(value);
  }

  public static IDateTimeItem valueOf(String value) {
    DateTimeAdapter adapter = (DateTimeAdapter) DataTypes.DATE_TIME.getJavaTypeAdapter();
