...
public class PositiveInteger implements IFunctionHandler {
  static final IFunction SIGNATURE = IFunction.newBuilder()
      ...
      .returnOne()
      .functionHandler(new PositiveInteger())
      .build();

  @Override
  public ISequence<IPositiveIntegerItem> execute(List<ISequence<?>> arguments, DynamicContext dynamicContext) {
    ...
    return ISequence.of(CastFunctions.castToPositiveInteger(argItem));
  }
}
