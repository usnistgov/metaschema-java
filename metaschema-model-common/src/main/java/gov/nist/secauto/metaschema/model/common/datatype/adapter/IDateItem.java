...
public interface IDateItem extends IAnyAtomicItem {
  ...
  public static IDateItem valueOf(@NotNull Date value) {
    return MetaschemaDataTypeProvider.DATE.newItem(value);
  }

  @NotNull
  public static IDateItem valueOf(@NotNull ZonedDateTime value) {
    return MetaschemaDataTypeProvider.DATE_WITH_TZ.newItem(value);
  }

  @NotNull
  public static IDateItem valueOf(@NotNull String value) throws IllegalArgumentException {
  ...
  @Override
  IDateType getItemType();

  @Override
  default IDateItem toAtomicItem() {
    return this;
  }
}
